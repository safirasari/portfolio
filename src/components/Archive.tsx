...
//         </h2>
//         <p className="text-sm font-titleFont text-textPink">
//           view the archive
//         </p>
//       </div>
...
//             className="w-36 h-12 rounded-md text-textPink text-[13px] border border-textPink hover:bg-hoverColor duration-300"
//           >
//             Show Less
//           </button>
//         ) : (
